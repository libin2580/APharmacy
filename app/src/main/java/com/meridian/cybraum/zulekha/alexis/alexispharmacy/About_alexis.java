...
public class About_alexis extends AppCompatActivity {
    @BindView(R.id.back)
    LinearLayout back;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.about_alexis);
               ...
               progressWheel.setVisibility(View.GONE);
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        String about_hospital = j.getJSONObject("about_hospital").getString("content");
                        System.out.println("___________aboutus___________" + about_hospital);
                        web.setText(about_hospital);
                        Glide.with(getApplicationContext())
                                .load(j.getJSONObject("about_hospital").getString("banner"))
    ...
    public void onViewClicked() {
        Intent q = new Intent(About_alexis.this, MainActivity.class);
        startActivity(q);
        finish();
    }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(About_alexis.this, Medication_Activity.class);
