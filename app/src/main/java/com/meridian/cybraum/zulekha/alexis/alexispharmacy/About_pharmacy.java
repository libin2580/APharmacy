...
public class About_pharmacy extends AppCompatActivity {
    @BindView(R.id.back)
    LinearLayout back;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.about_pharmacy);
            ...
            public void success(@NotNull Request request, @NotNull Response response, String data) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        String about_hospital = j.getJSONObject("about_pharmacy").getString("content");
                        System.out.println("___________aboutus___________" + about_hospital);
                        web.setText(about_hospital);
                        Glide.with(getApplicationContext())
                                .load( j.getJSONObject("about_pharmacy").getString("banner"))
    ...
    public void onViewClicked() {
        Intent q = new Intent(About_pharmacy.this, MainActivity.class);
        startActivity(q);
        finish();
    }
    @Override
    public void onBackPressed() {
        ...
        Intent intent = new Intent(About_pharmacy.this,Medication_Activity.class);
